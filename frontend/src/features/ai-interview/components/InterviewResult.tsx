        ...
        {[
          ...
          <Card key={label}>
            <CardContent className="p-5">
              <p className="text-xs uppercase tracking-[0.18em] text-ink-400 dark:text-ink-300">{label}</p>
            ...
            <CardContent className="space-y-5 p-6">
              <div className="flex flex-wrap items-center justify-between gap-3">
                ...
                <div className="flex flex-wrap items-center gap-3">
                  ...
                  <span className="text-sm text-ink-500 dark:text-ink-300">Score: {answer.score ?? 'Pending manual review'}</span>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <p className="rounded-2xl border border-dashed border-ink-200 p-4 text-sm text-ink-600 dark:border-white/10 dark:text-ink-300">
